...
const ExtractTextPlugin = require('extract-text-webpack-plugin') //单独提取css文件模块
...
const webpackConfig = merge(baseWebpackConfig, {
  module: {
    rules: utils.styleLoaders({//增加模块处理规则
      sourceMap: config.build.productionSourceMap, //对于所有的css的loader都进行初始化配置
      extract: true,
      usePostCSS: true
    })
  },
  ...
  plugins: [
    ...
    new webpack.optimize.CommonsChunkPlugin({ //将打包后的文件复制到指定目录
      name: 'app',
      async: 'vendor-async',
      children: true,
      minChunks: 3
